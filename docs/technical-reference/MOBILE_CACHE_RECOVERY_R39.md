...
- Installed-app launch is release-bound to `20260807-r39-mobile-cache-recovery`.
...
- Production activation marker: `2026-08-07T05:53Z`.
- Independent production acceptance uses pull-before-write ordering and records the exact public artifact after eight-route readback.
