...
export const secondaryTranslations = [
  ...
  ["No Monetary Value、Rate Limit、Abuse Controlを前提に公開します。", "仅在无货币价值、速率限制和滥用控制前提下公开。", "Publicar bajo las condiciones de ausencia de valor monetario, límites de tasa y controles de abuso.", "Pubblicare con assenza di valore monetario, rate limit e controlli antiabuso.", "يُنشر بشرط انعدام القيمة المالية ووجود حدود للمعدل وضوابط إساءة الاستخدام."],
  ...
  ["テスト資産が金銭的価値を表さないことを示す必須のテストネット表示。", "用于表明测试资产不代表货币价值的强制性测试网标识。", "Aviso obligatorio de Testnet que indica que los activos de prueba no representan valor monetario.", "Avviso Testnet obbligatorio che indica che gli asset di prova non rappresentano valore monetario.", "إشعار إلزامي لشبكة الاختبار يبيّن أن أصول الاختبار لا تمثل قيمة مالية."],
