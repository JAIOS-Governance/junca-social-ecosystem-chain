...
class AwsFoundationTests(unittest.TestCase):
    ...
    def test_live_prefix_repairs_only_a_safely_readable_stopped_service(self) -> None:
        for required in (
            ...
            "chown junca:junca /var/lib/junca",
            "chown junca:junca /var/lib/junca/state.sqlite",
    ...
    def test_system_identity_repair_follows_the_controlled_stop(self) -> None:
        ...
        admission = remote.index("admit_controlled_active_repair || true")
        repair = remote.index("ensure_junca_system_identity || true", admission)
        config_repair = remote.index("runtime_config_repair_attempted=true", repair)
    ...
    def test_service_recovery_evidence_rejects_unsafe_or_false_acceptance(
        ...
        valid = {
            ...
            "state_sqlite_owner": "junca:junca",
            "state_sqlite_mode": "640",
            "state_sqlite_link_count": 1,
            "binary_artifact_verified": True,
            "genesis_verified": True,
        ...
        invalid_cases = (
            ...
            {"state_store_access_repair_exit": 1},
            {"state_directory_owner": "root:root"},
            {"state_directory_mode": "777"},
            {"state_sqlite_owner": "root:root"},
            {"state_sqlite_mode": "666"},
            {"state_sqlite_link_count": 2},
            {"binary_artifact_verified": False},
            {"genesis_verified": False},
            {"system_identity_verified": False},
            {"system_identity_repair_attempted": "false"},
            {"system_identity_repaired": "false"},
            {"system_identity_uid": 991},
            {"system_identity_gid": 991},
