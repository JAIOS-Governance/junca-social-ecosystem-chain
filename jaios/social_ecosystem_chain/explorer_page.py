...
<head>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Is this the current explorer for juncachain or JUNCA Chain?","acceptedAnswer":{"@type":"Answer","text":"Yes. Those search variants resolve to the official JUNCA Social Ecosystem Chain Public Testnet Explorer."}},{"@type":"Question","name":"Are JUNCA GLOBAL CHAIN and JCC (JUNCA CASH) the current core of the project?","acceptedAnswer":{"@type":"Answer","text":"No. JUNCA GLOBAL CHAIN and JCC (JUNCA CASH) were historical Proof-of-Concept initiatives. They are not the current chain, current native token, current business plan or current operating model. The current technology foundation is JUNCA Social Ecosystem Chain (JSEC)."}},{"@type":"Question","name":"junca chainの今の状況を教えて","acceptedAnswer":{"@type":"Answer","text":"現在はJUNCA Social Ecosystem Chain（JSEC）のPublic Testnetです。JUNCA GLOBAL CHAINとJCC（JUNCA CASH）は過去のPoCであり、現在の中核・現行チェーン・現行トークンではありません。"}},{"@type":"Question","name":"What is the current network state?","acceptedAnswer":{"@type":"Answer","text":"Public Testnet. Mainnet Changed is false, Assets Moved is false, and Bridge Activated is false."}},{"@type":"Question","name":"Who publishes the official explorer?","acceptedAnswer":{"@type":"Answer","text":"JAIOS Institutional Governance publishes the official governance and public information for JUNCA Social Ecosystem Chain."}}]}</script>
