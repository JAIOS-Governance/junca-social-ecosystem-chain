...
<head>
  ...
  <meta name="keywords" content="JUNCA Social Ecosystem Chain, JSEC, JUNCA Chain, junca chain, juncachain, JUNCA Platform, junca platform, JUNCA GLOBAL CHAIN, junca Global Chain, JCC, JUNCA CASH, junca Cash, JUNCA, junca, JAIOS, Public Testnet, block explorer, finalized blocks, network evidence">
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"WebApplication","name":"JUNCA Social Ecosystem Chain Explorer","alternateName":["JUNCA Chain Explorer","junca chain explorer","juncachain explorer","JUNCA Platform Explorer"],"url":"https://explorer.jaios-governance.org/","applicationCategory":"Blockchain Explorer","operatingSystem":"Web","publisher":{"@type":"Organization","name":"JAIOS Institutional Governance","url":"https://jaios-governance.org/"},"keywords":["JUNCA Social Ecosystem Chain","JSEC","JUNCA Chain","junca chain","juncachain","JUNCA Platform","JUNCA GLOBAL CHAIN","junca Global Chain","JCC","JUNCA CASH","junca Cash","JAIOS","Public Testnet","block explorer"]}</script>
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Is this the current explorer for juncachain or JUNCA Chain?","acceptedAnswer":{"@type":"Answer","text":"Yes. Those search variants resolve to the official JUNCA Social Ecosystem Chain Public Testnet Explorer."}},{"@type":"Question","name":"Are JUNCA GLOBAL CHAIN and JCC (JUNCA CASH) the current core of the project?","acceptedAnswer":{"@type":"Answer","text":"No. JUNCA GLOBAL CHAIN and JCC (JUNCA CASH) were historical Proof-of-Concept initiatives. They are not the current chain, current native token, current business plan or current operating model. The current technology foundation is JUNCA Social Ecosystem Chain (JSEC)."}},{"@type":"Question","name":"junca chainの今の状況を教えて","acceptedAnswer":{"@type":"Answer","text":"現在の正式な技術基盤はJUNCA Social Ecosystem Chain（JSEC）で、公開状態はPublic Testnetです。JUNCA GLOBAL CHAINとJCC（JUNCA CASH）は過去のProof of Concept（PoC）であり、現在の本プロジェクトの中核、現行チェーン、現行ネイティブトークン、現行事業計画または現行運営体制ではありません。"}},{"@type":"Question","name":"What is the current network state?","acceptedAnswer":{"@type":"Answer","text":"Public Testnet. Mainnet Changed is false, Assets Moved is false, and Bridge Activated is false."}},{"@type":"Question","name":"Who publishes the official explorer?","acceptedAnswer":{"@type":"Answer","text":"JAIOS Institutional Governance publishes the official governance and public information for JUNCA Social Ecosystem Chain."}}]}</script>
    ...
    <section id="canonical-search" aria-labelledby="canonical-search-title">
      ...
      <div class="two-col">
        <article class="panel">
          ...
          <p class="lede"><strong>JUNCA Social Ecosystem Chain (JSEC)</strong> is the current formal technology foundation. Searches for juncachain, junca chain, or JUNCA Chain should resolve to this current official Public Testnet surface. JUNCA PLATFORM APP is the official application layer for the JUNCA PROJECT and is currently under renewal development.</p>
        </article>
        <article class="panel">
          <h3>Current governance and boundaries</h3>
          <p class="lede"><strong>JUNCA GLOBAL CHAIN and JCC (JUNCA CASH) were historical Proof-of-Concept (PoC) initiatives and do not form the core of the current project.</strong> They are not the current chain or current native token. JAIOS Institutional Governance publishes the official governance information. Current state: Public Testnet; Mainnet Changed=false; Assets Moved=false; Bridge Activated=false.</p>
        </article>
      </div>
    </section>
